...
const courses: Course[] = [
  {
    ...
    description: "Développez des compétences en planification et exécution stratégique",
    category: "management",
    notionLink: "https://notion.so/management-strategique",
    color: "#3182ce",
    icon: "📊",
  },
  {
    ...
    description: "Apprenez les méthodes de recherche académique et professionnelle",
    category: "research",
    notionLink: "https://notion.so/methodologie-recherche",
    color: "#805ad5",
    icon: "🔍",
  },
  {
    ...
    description: "Maîtrisez les techniques de gestion budgétaire et prévisionnelle",
    category: "finance",
    notionLink: "https://notion.so/gestion-budgetaire",
    color: "#38a169",
    icon: "💰",
  },
  {
    ...
    description: "Élaborez des stratégies financières efficaces pour les organisations",
    category: "finance",
    notionLink: "https://notion.so/strategie-financiere",
    badge: "Popular",
    color: "#38a169",
    icon: "📈",
  },
  {
    ...
    description: "Apprenez les principes et pratiques de l'audit financier",
    category: "finance",
    notionLink: "https://notion.so/audit-comptable",
    color: "#38a169",
    icon: "🧮",
  },
  {
    ...
    description: "Développez vos compétences en anglais professionnel",
    category: "languages",
  ...
  },
  {
    ...
    description: "Améliorez votre espagnol dans un contexte professionnel",
    category: "languages",
  ...
  },
  {
    ...
    description: "Maîtrisez les méthodologies de gestion de projet",
    category: "management",
  ...
  },
  {
    ...
    description: "Développez les compétences nécessaires pour créer et gérer une entreprise",
    category: "business",
  ...
  },
  {
    ...
    description: "Apprenez à communiquer efficacement dans un contexte professionnel",
